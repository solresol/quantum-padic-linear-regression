...
def _quantum_add_inplace(circ: QuantumCircuit,
    ...
    # Key insight: we must uncompute scratch[i] while scratch[i-1] still has its computed value
    # So we uncompute from high to low: scratch[n-2], scratch[n-3], ..., scratch[0]
